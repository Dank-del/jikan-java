 ...
 */
@JsonAdapter(SearchQuerySort.Adapter.class)
public enum SearchQuerySort {
  ...
  public static SearchQuerySort fromValue(String value) {
    for (SearchQuerySort b : SearchQuerySort.values()) {
  ...
  public static class Adapter extends TypeAdapter<SearchQuerySort> {
    @Override
    public void write(final JsonWriter jsonWriter, final SearchQuerySort enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SearchQuerySort read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SearchQuerySort.fromValue(value);
    }
  }
}
