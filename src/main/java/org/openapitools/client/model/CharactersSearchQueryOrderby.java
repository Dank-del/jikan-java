 ...
 */
@JsonAdapter(CharactersSearchQueryOrderby.Adapter.class)
public enum CharactersSearchQueryOrderby {
  ...
  CharactersSearchQueryOrderby(String value) {
    this.value = value;
  }
  ...
  public static CharactersSearchQueryOrderby fromValue(String value) {
    for (CharactersSearchQueryOrderby b : CharactersSearchQueryOrderby.values()) {
  ...
  public static class Adapter extends TypeAdapter<CharactersSearchQueryOrderby> {
    @Override
    public void write(final JsonWriter jsonWriter, final CharactersSearchQueryOrderby enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CharactersSearchQueryOrderby read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CharactersSearchQueryOrderby.fromValue(value);
    }
  }
}
