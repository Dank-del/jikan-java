 ...
 */
@JsonAdapter(AnimeSearchQueryOrderby.Adapter.class)
public enum AnimeSearchQueryOrderby {
  ...
  AnimeSearchQueryOrderby(String value) {
    this.value = value;
  }
  ...
  public static AnimeSearchQueryOrderby fromValue(String value) {
    for (AnimeSearchQueryOrderby b : AnimeSearchQueryOrderby.values()) {
  ...
  public static class Adapter extends TypeAdapter<AnimeSearchQueryOrderby> {
    @Override
    public void write(final JsonWriter jsonWriter, final AnimeSearchQueryOrderby enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AnimeSearchQueryOrderby read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AnimeSearchQueryOrderby.fromValue(value);
    }
  }
}
