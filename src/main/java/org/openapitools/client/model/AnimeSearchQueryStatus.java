 ...
 */
@JsonAdapter(AnimeSearchQueryStatus.Adapter.class)
public enum AnimeSearchQueryStatus {
  ...
  AnimeSearchQueryStatus(String value) {
    this.value = value;
  }
  ...
  public static AnimeSearchQueryStatus fromValue(String value) {
    for (AnimeSearchQueryStatus b : AnimeSearchQueryStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<AnimeSearchQueryStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AnimeSearchQueryStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AnimeSearchQueryStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AnimeSearchQueryStatus.fromValue(value);
    }
  }
}
