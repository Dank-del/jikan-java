 ...
 */
@JsonAdapter(ProducersQueryOrderby.Adapter.class)
public enum ProducersQueryOrderby {
  ...
  ProducersQueryOrderby(String value) {
    this.value = value;
  }
  ...
  public static ProducersQueryOrderby fromValue(String value) {
    for (ProducersQueryOrderby b : ProducersQueryOrderby.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProducersQueryOrderby> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProducersQueryOrderby enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProducersQueryOrderby read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProducersQueryOrderby.fromValue(value);
    }
  }
}
