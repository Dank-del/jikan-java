 ...
 */
@JsonAdapter(AnimeSearchQueryRating.Adapter.class)
public enum AnimeSearchQueryRating {
  ...
  AnimeSearchQueryRating(String value) {
    this.value = value;
  }
  ...
  public static AnimeSearchQueryRating fromValue(String value) {
    for (AnimeSearchQueryRating b : AnimeSearchQueryRating.values()) {
  ...
  public static class Adapter extends TypeAdapter<AnimeSearchQueryRating> {
    @Override
    public void write(final JsonWriter jsonWriter, final AnimeSearchQueryRating enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AnimeSearchQueryRating read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AnimeSearchQueryRating.fromValue(value);
    }
  }
}
