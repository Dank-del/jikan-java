 ...
 */
@JsonAdapter(MagazinesQueryOrderby.Adapter.class)
public enum MagazinesQueryOrderby {
  ...
  MagazinesQueryOrderby(String value) {
    this.value = value;
  }
  ...
  public static MagazinesQueryOrderby fromValue(String value) {
    for (MagazinesQueryOrderby b : MagazinesQueryOrderby.values()) {
  ...
  public static class Adapter extends TypeAdapter<MagazinesQueryOrderby> {
    @Override
    public void write(final JsonWriter jsonWriter, final MagazinesQueryOrderby enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MagazinesQueryOrderby read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MagazinesQueryOrderby.fromValue(value);
    }
  }
}
