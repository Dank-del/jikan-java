 ...
 */
@JsonAdapter(MangaSearchQueryType.Adapter.class)
public enum MangaSearchQueryType {
  ...
  MangaSearchQueryType(String value) {
    this.value = value;
  }
  ...
  public static MangaSearchQueryType fromValue(String value) {
    for (MangaSearchQueryType b : MangaSearchQueryType.values()) {
  ...
  public static class Adapter extends TypeAdapter<MangaSearchQueryType> {
    @Override
    public void write(final JsonWriter jsonWriter, final MangaSearchQueryType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MangaSearchQueryType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MangaSearchQueryType.fromValue(value);
    }
  }
}
