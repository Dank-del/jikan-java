 ...
 */
@JsonAdapter(ClubSearchQueryOrderby.Adapter.class)
public enum ClubSearchQueryOrderby {
  ...
  ClubSearchQueryOrderby(String value) {
    this.value = value;
  }
  ...
  public static ClubSearchQueryOrderby fromValue(String value) {
    for (ClubSearchQueryOrderby b : ClubSearchQueryOrderby.values()) {
  ...
  public static class Adapter extends TypeAdapter<ClubSearchQueryOrderby> {
    @Override
    public void write(final JsonWriter jsonWriter, final ClubSearchQueryOrderby enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ClubSearchQueryOrderby read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ClubSearchQueryOrderby.fromValue(value);
    }
  }
}
