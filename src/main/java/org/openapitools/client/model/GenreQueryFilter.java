 ...
 */
@JsonAdapter(GenreQueryFilter.Adapter.class)
public enum GenreQueryFilter {
  ...
  public static GenreQueryFilter fromValue(String value) {
    for (GenreQueryFilter b : GenreQueryFilter.values()) {
  ...
  public static class Adapter extends TypeAdapter<GenreQueryFilter> {
    @Override
    public void write(final JsonWriter jsonWriter, final GenreQueryFilter enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GenreQueryFilter read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GenreQueryFilter.fromValue(value);
    }
  }
}
