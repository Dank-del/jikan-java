 ...
 */
@JsonAdapter(ClubSearchQueryCategory.Adapter.class)
public enum ClubSearchQueryCategory {
  ...
  ClubSearchQueryCategory(String value) {
    this.value = value;
  }
  ...
  public static ClubSearchQueryCategory fromValue(String value) {
    for (ClubSearchQueryCategory b : ClubSearchQueryCategory.values()) {
  ...
  public static class Adapter extends TypeAdapter<ClubSearchQueryCategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final ClubSearchQueryCategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ClubSearchQueryCategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ClubSearchQueryCategory.fromValue(value);
    }
  }
}
