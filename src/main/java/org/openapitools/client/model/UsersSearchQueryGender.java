 ...
 */
@JsonAdapter(UsersSearchQueryGender.Adapter.class)
public enum UsersSearchQueryGender {
  ...
  UsersSearchQueryGender(String value) {
    this.value = value;
  }
  ...
  public static UsersSearchQueryGender fromValue(String value) {
    for (UsersSearchQueryGender b : UsersSearchQueryGender.values()) {
  ...
  public static class Adapter extends TypeAdapter<UsersSearchQueryGender> {
    @Override
    public void write(final JsonWriter jsonWriter, final UsersSearchQueryGender enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UsersSearchQueryGender read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UsersSearchQueryGender.fromValue(value);
    }
  }
}
