 ...
 */
@JsonAdapter(AnimeSearchQueryType.Adapter.class)
public enum AnimeSearchQueryType {
  ...
  AnimeSearchQueryType(String value) {
    this.value = value;
  }
  ...
  public static AnimeSearchQueryType fromValue(String value) {
    for (AnimeSearchQueryType b : AnimeSearchQueryType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AnimeSearchQueryType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AnimeSearchQueryType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AnimeSearchQueryType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AnimeSearchQueryType.fromValue(value);
    }
  }
}
