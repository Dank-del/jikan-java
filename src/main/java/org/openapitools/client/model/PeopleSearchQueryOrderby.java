 ...
 */
@JsonAdapter(PeopleSearchQueryOrderby.Adapter.class)
public enum PeopleSearchQueryOrderby {
  ...
  PeopleSearchQueryOrderby(String value) {
    this.value = value;
  }
  ...
  public static PeopleSearchQueryOrderby fromValue(String value) {
    for (PeopleSearchQueryOrderby b : PeopleSearchQueryOrderby.values()) {
  ...
  public static class Adapter extends TypeAdapter<PeopleSearchQueryOrderby> {
    @Override
    public void write(final JsonWriter jsonWriter, final PeopleSearchQueryOrderby enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PeopleSearchQueryOrderby read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PeopleSearchQueryOrderby.fromValue(value);
    }
  }
}
