 ...
 */
@JsonAdapter(ClubSearchQueryType.Adapter.class)
public enum ClubSearchQueryType {
  ...
  ClubSearchQueryType(String value) {
    this.value = value;
  }
  ...
  public static ClubSearchQueryType fromValue(String value) {
    for (ClubSearchQueryType b : ClubSearchQueryType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ClubSearchQueryType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ClubSearchQueryType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ClubSearchQueryType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ClubSearchQueryType.fromValue(value);
    }
  }
}
