 ...
 */
@JsonAdapter(MangaSearchQueryOrderby.Adapter.class)
public enum MangaSearchQueryOrderby {
  ...
  MangaSearchQueryOrderby(String value) {
    this.value = value;
  }
  ...
  public static MangaSearchQueryOrderby fromValue(String value) {
    for (MangaSearchQueryOrderby b : MangaSearchQueryOrderby.values()) {
  ...
  public static class Adapter extends TypeAdapter<MangaSearchQueryOrderby> {
    @Override
    public void write(final JsonWriter jsonWriter, final MangaSearchQueryOrderby enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MangaSearchQueryOrderby read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MangaSearchQueryOrderby.fromValue(value);
    }
  }
}
