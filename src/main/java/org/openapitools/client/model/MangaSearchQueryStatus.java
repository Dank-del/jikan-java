 ...
 */
@JsonAdapter(MangaSearchQueryStatus.Adapter.class)
public enum MangaSearchQueryStatus {
  ...
  MangaSearchQueryStatus(String value) {
    this.value = value;
  }
  ...
  public static MangaSearchQueryStatus fromValue(String value) {
    for (MangaSearchQueryStatus b : MangaSearchQueryStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<MangaSearchQueryStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final MangaSearchQueryStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MangaSearchQueryStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MangaSearchQueryStatus.fromValue(value);
    }
  }
}
