...
import org.openapitools.client.model.GenreQueryFilter;
import org.openapitools.client.model.Genres;
...
public class GenresApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Returns entry genres, explicit_genres, themes and demographics </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Error: Bad request. When required parameters were not supplied. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAnimeGenresCall(GenreQueryFilter filter, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/genres/anime";
    ...
    private okhttp3.Call getAnimeGenresValidateBeforeCall(GenreQueryFilter filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAnimeGenresCall(filter, _callback);
        return localVarCall;
     ...
     */
    public Genres getAnimeGenres(GenreQueryFilter filter) throws ApiException {
        ApiResponse<Genres> localVarResp = getAnimeGenresWithHttpInfo(filter);
     ...
     */
    public ApiResponse<Genres> getAnimeGenresWithHttpInfo(GenreQueryFilter filter) throws ApiException {
        okhttp3.Call localVarCall = getAnimeGenresValidateBeforeCall(filter, null);
        Type localVarReturnType = new TypeToken<Genres>(){}.getType();
     ...
     */
    public okhttp3.Call getAnimeGenresAsync(GenreQueryFilter filter, final ApiCallback<Genres> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAnimeGenresValidateBeforeCall(filter, _callback);
        Type localVarReturnType = new TypeToken<Genres>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getMangaGenres
     * @param filter  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getMangaGenresCall(GenreQueryFilter filter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/genres/manga";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMangaGenresValidateBeforeCall(GenreQueryFilter filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getMangaGenresCall(filter, _callback);
        return localVarCall;
     ...
     */
    public Genres getMangaGenres(GenreQueryFilter filter) throws ApiException {
        ApiResponse<Genres> localVarResp = getMangaGenresWithHttpInfo(filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Genres> getMangaGenresWithHttpInfo(GenreQueryFilter filter) throws ApiException {
        okhttp3.Call localVarCall = getMangaGenresValidateBeforeCall(filter, null);
        Type localVarReturnType = new TypeToken<Genres>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getMangaGenresAsync(GenreQueryFilter filter, final ApiCallback<Genres> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMangaGenresValidateBeforeCall(filter, _callback);
        Type localVarReturnType = new TypeToken<Genres>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
