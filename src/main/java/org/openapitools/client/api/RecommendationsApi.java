...
public class RecommendationsApi {
    ...
    /**
     * Build call for getRecentAnimeRecommendations
     * @param page  (optional)
     ...
     */
    public okhttp3.Call getRecentAnimeRecommendationsCall(Integer page, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/recommendations/anime";
    ...
    private okhttp3.Call getRecentAnimeRecommendationsValidateBeforeCall(Integer page, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getRecentAnimeRecommendationsCall(page, _callback);
        return localVarCall;
     ...
     */
    public Recommendations getRecentAnimeRecommendations(Integer page) throws ApiException {
        ApiResponse<Recommendations> localVarResp = getRecentAnimeRecommendationsWithHttpInfo(page);
     ...
     */
    public ApiResponse<Recommendations> getRecentAnimeRecommendationsWithHttpInfo(Integer page) throws ApiException {
        okhttp3.Call localVarCall = getRecentAnimeRecommendationsValidateBeforeCall(page, null);
     ...
     */
    public okhttp3.Call getRecentAnimeRecommendationsAsync(Integer page, final ApiCallback<Recommendations> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRecentAnimeRecommendationsValidateBeforeCall(page, _callback);
        Type localVarReturnType = new TypeToken<Recommendations>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getRecentMangaRecommendations
     * @param page  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns recent manga recommendations </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Error: Bad request. When required parameters were not supplied. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getRecentMangaRecommendationsCall(Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/recommendations/manga";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRecentMangaRecommendationsValidateBeforeCall(Integer page, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getRecentMangaRecommendationsCall(page, _callback);
        return localVarCall;
     ...
     */
    public Recommendations getRecentMangaRecommendations(Integer page) throws ApiException {
        ApiResponse<Recommendations> localVarResp = getRecentMangaRecommendationsWithHttpInfo(page);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Recommendations> getRecentMangaRecommendationsWithHttpInfo(Integer page) throws ApiException {
        okhttp3.Call localVarCall = getRecentMangaRecommendationsValidateBeforeCall(page, null);
        Type localVarReturnType = new TypeToken<Recommendations>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getRecentMangaRecommendationsAsync(Integer page, final ApiCallback<Recommendations> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRecentMangaRecommendationsValidateBeforeCall(page, _callback);
        Type localVarReturnType = new TypeToken<Recommendations>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
