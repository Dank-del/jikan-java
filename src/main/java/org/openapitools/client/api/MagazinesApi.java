...
import org.openapitools.client.model.Magazines;
import org.openapitools.client.model.MagazinesQueryOrderby;
...
public class MagazinesApi {
    ...
    public MagazinesApi(ApiClient apiClient) {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Returns magazines collection </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Error: Bad request. When required parameters were not supplied. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getMagazinesCall(Integer page, Integer limit, String q, MagazinesQueryOrderby orderBy, SearchQuerySort sort, String letter, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getMagazinesValidateBeforeCall(Integer page, Integer limit, String q, MagazinesQueryOrderby orderBy, SearchQuerySort sort, String letter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getMagazinesCall(page, limit, q, orderBy, sort, letter, _callback);
        return localVarCall;
     ...
     */
    public Magazines getMagazines(Integer page, Integer limit, String q, MagazinesQueryOrderby orderBy, SearchQuerySort sort, String letter) throws ApiException {
        ApiResponse<Magazines> localVarResp = getMagazinesWithHttpInfo(page, limit, q, orderBy, sort, letter);
     ...
     */
    public ApiResponse<Magazines> getMagazinesWithHttpInfo(Integer page, Integer limit, String q, MagazinesQueryOrderby orderBy, SearchQuerySort sort, String letter) throws ApiException {
        okhttp3.Call localVarCall = getMagazinesValidateBeforeCall(page, limit, q, orderBy, sort, letter, null);
        Type localVarReturnType = new TypeToken<Magazines>(){}.getType();
     ...
     */
    public okhttp3.Call getMagazinesAsync(Integer page, Integer limit, String q, MagazinesQueryOrderby orderBy, SearchQuerySort sort, String letter, final ApiCallback<Magazines> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMagazinesValidateBeforeCall(page, limit, q, orderBy, sort, letter, _callback);
        Type localVarReturnType = new TypeToken<Magazines>(){}.getType();
