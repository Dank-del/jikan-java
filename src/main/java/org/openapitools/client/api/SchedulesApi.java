...
public class SchedulesApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Returns weekly schedule </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Error: Bad request. When required parameters were not supplied. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getSchedulesCall(Integer page, String filter, String kids, String sfw, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        if (kids != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("kids", kids));
        }
    ...
    private okhttp3.Call getSchedulesValidateBeforeCall(Integer page, String filter, String kids, String sfw, Integer limit, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getSchedulesCall(page, filter, kids, sfw, limit, _callback);
        return localVarCall;
     ...
     */
    public Schedules getSchedules(Integer page, String filter, String kids, String sfw, Integer limit) throws ApiException {
        ApiResponse<Schedules> localVarResp = getSchedulesWithHttpInfo(page, filter, kids, sfw, limit);
     ...
     */
    public ApiResponse<Schedules> getSchedulesWithHttpInfo(Integer page, String filter, String kids, String sfw, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = getSchedulesValidateBeforeCall(page, filter, kids, sfw, limit, null);
     ...
     */
    public okhttp3.Call getSchedulesAsync(Integer page, String filter, String kids, String sfw, Integer limit, final ApiCallback<Schedules> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSchedulesValidateBeforeCall(page, filter, kids, sfw, limit, _callback);
        Type localVarReturnType = new TypeToken<Schedules>(){}.getType();
