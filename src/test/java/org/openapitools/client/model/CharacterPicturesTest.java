...
/**
 * Model tests for CharacterPictures
 */
public class CharacterPicturesTest {
    private final CharacterPictures model = new CharacterPictures();
