...
/**
 * API tests for ProducersApi
 */
@Disabled
public class ProducersApiTest {

    private final ProducersApi api = new ProducersApi();

    /**
     * @throws ApiException if the Api call fails
     */
    @Test
    public void getProducerByIdTest() throws ApiException {
        Integer id = null;
        GetProducerById200Response response = api.getProducerById(id);
     ...
     */
    @Test
    public void getProducerExternalTest() throws ApiException {
        Integer id = null;
        ExternalLinks response = api.getProducerExternal(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getProducerFullByIdTest() throws ApiException {
        Integer id = null;
        GetProducerFullById200Response response = api.getProducerFullById(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getProducersTest() throws ApiException {
        Integer page = null;
        Integer limit = null;
        String q = null;
        ProducersQueryOrderby orderBy = null;
        SearchQuerySort sort = null;
        String letter = null;
        Producers response = api.getProducers(page, limit, q, orderBy, sort, letter);
        // TODO: test validations
    }
