...
/**
 * API tests for MagazinesApi
 */
@Disabled
public class MagazinesApiTest {

    private final MagazinesApi api = new MagazinesApi();

    /**
     * @throws ApiException if the Api call fails
     */
    @Test
    public void getMagazinesTest() throws ApiException {
        Integer page = null;
        Integer limit = null;
        String q = null;
        MagazinesQueryOrderby orderBy = null;
        SearchQuerySort sort = null;
        String letter = null;
        Magazines response = api.getMagazines(page, limit, q, orderBy, sort, letter);
